...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>bpmn</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BpmnExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.bpmn"));
				Activity root = BpmnFactory.eINSTANCE.createActivity();
