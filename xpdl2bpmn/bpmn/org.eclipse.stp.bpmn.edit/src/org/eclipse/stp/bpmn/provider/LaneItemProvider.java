		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Lane_properties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Lane_properties_feature", "_UI_Lane_type"),
				 BpmnPackage.Literals.LANE__PROPERTIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Lane_documentation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Lane_documentation_feature", "_UI_Lane_type"),
				 BpmnPackage.Literals.LANE__DOCUMENTATION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BpmnPackage.Literals.LANE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
