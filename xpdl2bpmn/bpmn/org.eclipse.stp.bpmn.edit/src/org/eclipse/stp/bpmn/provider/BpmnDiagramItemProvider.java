	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BpmnDiagram_documentation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BpmnDiagram_documentation_feature", "_UI_BpmnDiagram_type"),
				 BpmnPackage.Literals.BPMN_DIAGRAM__DOCUMENTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BpmnDiagram_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BpmnDiagram_name_feature", "_UI_BpmnDiagram_type"),
				 BpmnPackage.Literals.BPMN_DIAGRAM__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
