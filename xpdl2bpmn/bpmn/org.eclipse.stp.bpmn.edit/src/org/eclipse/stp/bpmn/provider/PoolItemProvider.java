		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pool_documentation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pool_documentation_feature", "_UI_Pool_type"),
				 BpmnPackage.Literals.POOL__DOCUMENTATION,
				 true,
				 false,
				 false,
