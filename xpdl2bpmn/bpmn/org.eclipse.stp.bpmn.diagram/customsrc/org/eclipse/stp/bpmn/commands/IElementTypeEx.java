...
/**
 * Sets an extra hint on the IElementType.
 * This is custom code, not generated by GMF/EMF.
 * 
 * We use the secondary hint to hold the value of the activity type that we need
 * to create.
 * This way, even though we have a single class for all activities we can still
 * have a different tool for each one of them.
 * 
...
public interface IElementTypeEx extends IHintedType {
	...
	/**
	 * @return a semantic hint that lives outside of the 
	 * extensible element types registry.
	 */
